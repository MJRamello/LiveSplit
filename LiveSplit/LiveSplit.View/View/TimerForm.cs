    ...
    public partial class TimerForm : Form
    {
        ...
        private bool MousePassThrough
        {
            set {
                ...
                // If we're trying to set to false and it's already false, don't bother doing
                // anything. We can't do this for setting to true because setting Opacity may have
                // messed the GWL_EXSTYLE flags up.
                ...
                {
                    // Not removing WS_EX_LAYERED because it may still be needed if Opacity != 1. It
                    // shouldn't really affect anything and setting Form.Opacity to 1 will remove it anyway:
        ...
        private void PaintForm(Graphics g, Region clip)
        {
            ...
            // Set MousePassThrough after setting Opacity, because setting Opacity can reset the
            // Form's WS_EX_LAYERED flag.
        ...
        private void SetGameImage(ToolStripMenuItem item, dynamic race)
        {
        ...
        private void SRL_RacesRefreshed(object sender, EventArgs e)
        {
